...
- [ ] Complete and validate local video source ingestion as required version-1 scope: mixed Add Source batches, file drop, managed copies, conditional normalization, content deduplication, exact-hash recovery, silent-video playback, and `source add --file`.
